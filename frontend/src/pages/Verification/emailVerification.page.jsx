...
import { ArrowRight, Mail, CheckCircle, LogIn, Key } from "lucide-react";
...
export default function EmailVerification() {
  ...
  return (
    <div
      className={`min-h-[80vh] flex flex-col justify-center items-center p-4 transition-all duration-500 ${
        isVerified
          ? "bg-gradient-to-br from-[#02ccc2] to-[#0f6284]"
        ...
        <CardHeader
          title={
            <Typography
              ...
              gutterBottom
              fontWeight={600}
              className={`${isVerified ? "text-white" : "text-black"}`}
            >
              {!isVerified ? `Verify Your Email` : `Email Verified`}
            </Typography>
          }
          subheader={
            <Typography
          ...
          {!isVerified ? (
            ...
            <div>
              <div className="flex justify-center mb-6">
                <div className="bg-white/30 p-4 rounded-full transition-transform duration-300 transform scale-100 hover:scale-105">
              ...
              <div className="flex justify-center space-x-4 w-full mt-8">
                <button
                  variant="secondary"
                  className="flex items-center bg-white rounded-md px-4 py-2 hover:bg-white/90"
